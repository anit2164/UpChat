...
const Layout = () => {
      ...
      label: (
        <div className={LayoutStyle.membersArea}>
          <div className={LayoutStyle.membersAreaLeft}>
            <img
              className={LayoutStyle.profileAvtar}
            ...
            <span
              className={` ${LayoutStyle.profileDesignation} ${LayoutStyle.sales} `}
            >
              Sales Consultant
            </span>
          </div>
      ...
      label: (
        <div className={LayoutStyle.membersArea}>
          <div className={LayoutStyle.membersAreaLeft}>
            ...
            <span
              className={` ${LayoutStyle.profileDesignation} ${LayoutStyle.deliveryTeam} `}
            >
              Delivery Team
            </span>
          </div>
      ...
      label: (
        <div className={LayoutStyle.membersArea}>
          <div className={LayoutStyle.membersAreaLeft}>
            ...
            <span
              className={` ${LayoutStyle.profileDesignation} ${LayoutStyle.coeteam} `}
            >
              COE Team
            </span>
          </div>
  ...
  return (
    <>
      ...
      <div
        className={` ${LayoutStyle.channelWindow} ${LayoutStyle.bookmarkChannelWindow} `}
      >
        <div className={LayoutStyle.channelWindowHeader}>
          <div className={LayoutStyle.channelHeaderLeft}>
            <div
              className={` ${LayoutStyle.chatInitialThumb} ${LayoutStyle.blueThumb} `}
            >
              AN
            </div>
            <div className={LayoutStyle.channelName}>
              Senior Backend... | Andela | HR170523201242
            </div>
          </div>
          <div className={LayoutStyle.channelHeaderRight}>
            <Dropdown
              className={` ${LayoutStyle.dotMenuMain} ${LayoutStyle.dotMenuhz} `}
        ...
        <div className={LayoutStyle.channelWindowInner}>
          <div className={LayoutStyle.channelWindowMessages}>
            <div className={LayoutStyle.channelMessageMain}>
              ...
              <div
                className={` ${LayoutStyle.channelMessageBox} ${LayoutStyle.channelMessageRight} `}
              >
                <p>
            ...
            <div className={LayoutStyle.channelMessageMain}>
              ...
              <div
                className={` ${LayoutStyle.channelMessageBox} ${LayoutStyle.channelMessageLeft} `}
              >
                <p>
      ...
      <div
        className={` ${LayoutStyle.channelWindow} ${LayoutStyle.channelWindowTwo} `}
      >
        <div className={LayoutStyle.channelWindowHeader}>
          <div className={LayoutStyle.channelHeaderLeft}>
            <div
        ...
        <div className={LayoutStyle.channelWindowStatus}>
          ...
          <div className={LayoutStyle.channelStatusRight}>
            <span>6 members</span>
            <Dropdown
              className={LayoutStyle.channelStatusInfo}
              placement="bottomRight"
              menu={{
        ...
        <div className={LayoutStyle.channelWindowInner}>
          <div className={LayoutStyle.channelWindowMessages}>
            ...
            <div className={LayoutStyle.channelMessageMain}>
              ...
              >
                <p>
                  ...
                  provided HR details, how many more interviews can we schedule
                  by tommorow.
                </p>
                <div className={LayoutStyle.messageReactionWrapper}>
                  <span className={LayoutStyle.messageReaction}>
            ...
            <div className={LayoutStyle.divider}>
              <span className={LayoutStyle.dividerInner}>
                2 Unread Messages
              </span>
            </div>
          ...
          <span className={LayoutStyle.scrollToBottom}>
            <ScrollToBottomSVG />
          </span>
        </div>
        <div className={LayoutStyle.channelWindowFooterWrap}>
          <div className={LayoutStyle.channelWindowFooter}>
            ...
            <span
              className={` ${LayoutStyle.channelAddMedia} ${LayoutStyle.channelAddMediaActive} `}
            >
              <div className={LayoutStyle.mediaOptions}>
                <span>
                  <SmileIcon />
                  <div
                    className={` ${LayoutStyle.chatPopup} ${LayoutStyle.chatArrowBottom} ${LayoutStyle.emojiPopup} `}
                    style={{
                      display: "none",
                    }}
                  >
                ...
                <span className={LayoutStyle.mediaOptionsActive}>
                  <FiImageSVG />
                  <div
                    className={` ${LayoutStyle.chatPopup} ${LayoutStyle.chatArrowBottom} ${LayoutStyle.attachementPopup} `}
                    style={{
                      display: "none",
                    }}
                  >
                    <div className={LayoutStyle.chatPopupInner}>
                      <div className={LayoutStyle.popupContent}>
                        ...
                        <div className={LayoutStyle.attachedMedia}>
                          <span>
                            <span
                              className={LayoutStyle.chatWindowClose}
                            ></span>
                            <img
      ...
      <div
        className={` ${LayoutStyle.channelWindow} ${LayoutStyle.channelWindowThree} `}
      >
        <div className={LayoutStyle.channelWindowHeader}>
          <div className={LayoutStyle.channelHeaderLeft}>
            <div
        ...
        <div className={LayoutStyle.channelWindowInner}>
          <div className={LayoutStyle.searchInChatWrapper}>
            <div className={LayoutStyle.searchInChatInner}>
              ...
              <span className={LayoutStyle.numberOfSearch}>
                <span className={LayoutStyle.arrowIcon}>
                  <ArrowIcon />
                </span>
                3/17
                <span className={LayoutStyle.arrowIconRight}>
                  <ArrowIcon />
                </span>
              </span>
            </div>
          ...
          <div className={LayoutStyle.channelWindowMessages}>
            <div className={LayoutStyle.channelMessageMain}>
              ...
              >
                <div className={LayoutStyle.quotedMessage}>
                  ...
                  <div className={LayoutStyle.quotedMessageChild}>
                    <FiReplySVG width="10" height="16" />
                    Darshan Modi, <span>Today at 12:31PM</span>
                  </div>
                </div>
                <p>
                  Yes <b>Darshan</b>, kindly proceed.
                </p>
                <div className={LayoutStyle.chatReaction}>
                  <div className={LayoutStyle.chatReactionInner}>
                    <div className={LayoutStyle.chatReactionCircle}>
            ...
            <div
              className={` ${LayoutStyle.channelMessageMain} ${LayoutStyle.systemGeneratedMain} `}
            >
            ...
            >
              ...
              <div
                className={` ${LayoutStyle.systemGeneratedInner} ${LayoutStyle.systemGeneratedCollapsed} `}
              >
                <span>
                  Note: Years of exp a) .NET Developer Sr: 4 -6 years b) Test
                  Automation Engineer Sr: 3.5 - 6 years c) Android Developer: 3
                  - 5 years d) iOS Developer: 3 - 5 years Key Skills: a) .NET
                  Developer Sr : .Net + .Net Core + C# + Typescript (Angular) b)
                  Test Automation Engineer Sr: Automation Testing + BDD
                  Framework Selenium with Java +Jenkins Budget: a) .NET
                  Developer Sr:15-17 LPA b) Test Automation Engineer Sr: 15-17
                  LPA c) Android Developer: 15-17 LPA d) iOS Developer: 15-17
                  LPA If we feel that a candidate is really good all he or she
                  ticks all the boxes then we can consider 19LPA for them.
                  Additional information Preference should be given to Bangalore
                  candidates. Preference should be given to candidates with a
                  lesser notice period. Avoid sourcing candidates from regions
          ...
          <div className={LayoutStyle.replyToWrapper}>
            <div className={LayoutStyle.replyToTop}>
              <FiReplySVG />
              Replying to Darshan Modi, <span>Today at 12:31PM</span>
              <span className={LayoutStyle.chatWindowClose}></span>
            </div>
            <div className={LayoutStyle.replyToMessage}>
              <p>
                That will be great <b>Prachi & Bhuvan</b>, this will help us get
                things moving ahead with a schedule.
              </p>
